...
========================================*/
  ...
  /* Nice Select Js */
  $("select").not(".gie-product-select").niceSelect();
  ...
  document.addEventListener("DOMContentLoaded", function () {
    ...
    function myFunction(e) {
      ...
      var left = Math.min(
        Math.max(x - triggerRect.left - tooltipWidth / 2, -buffer),
        maxX,
      );
      var top = Math.min(
        Math.max(y - triggerRect.top - tooltipHeight / 2, -buffer),
        maxY,
      );
  ...
  $(document).ready(function () {
    ...
    $(".rs-swiper .swiper").each(function (index) {
      var $swiper = $(this);
      var hoverAutoplay =
        $swiper.data("hover-pause") === undefined
          ? true
          : $swiper.data("hover-pause");
      var loop =
        $(this).data("loop") === undefined ? true : $(this).data("loop");
      var centeredSlides =
        $(this).data("center-mode") === undefined
          ? false
          : $(this).data("center-mode");
      var autoplay =
        $(this).data("autoplay") === undefined
          ? true
          : $(this).data("autoplay");
      var dynamicBullets =
        $(this).data("dots-dynamic") === undefined
          ? true
          : $(this).data("dots-dynamic");
      var direction =
        $(this).data("direction") === "vertical" ? "vertical" : "horizontal";
      var fridgeMovement =
        $(this).data("play-slide") === undefined
          ? true
          : $(this).data("play-slide");
      var effect = $(this).data("effect") || "slide"; //'slide' | 'fade' | 'cube' | 'coverflow' | 'flip' | 'creative' | 'cards';
      var grabCursor =
        $(this).data("grab-cursor") === undefined
          ? false
          : $(this).data("grab-cursor");
      var oneWayMovement =
        $(this).data("one-way") === undefined ? false : $(this).data("one-way");
      ...
      var autoHeight =
        $swiper.data("auto-height") === true ||
        $swiper.data("auto-height") === "true";
      var observer =
        $swiper.data("observer") === true ||
        $swiper.data("observer") === "true";
      var observeParents =
        $swiper.data("observe-parents") === true ||
        $swiper.data("observe-parents") === "true";
      ...
      var marginXl = $(this).data("margin-xl")
        ? $(this).data("margin-xl")
        : margin;
      var marginLg = $(this).data("margin-lg")
        ? $(this).data("margin-lg")
        : marginXl;
      var marginMd = $(this).data("margin-md")
        ? $(this).data("margin-md")
        : marginLg;
      var marginSm = $(this).data("margin-sm")
        ? $(this).data("margin-sm")
        : marginMd;
      var marginXs = $(this).data("margin-xs")
        ? $(this).data("margin-xs")
        : marginSm;
      var marginMobile = $(this).data("margin-mobile")
        ? $(this).data("margin-mobile")
        : marginXs;
    ...
    if ($(".rs-services-tab-wrapper.auto-switch").length) {
      ...
      function switchTabs() {
        ...
        var $nextTab = $activeTab
          .closest(".nav-item")
          .next(".nav-item")
          .find(".nav-link");
        if (!$nextTab.length) {
          $nextTab = $(".rs-services-tab-wrapper.auto-switch .nav-item")
            .first()
            .find(".nav-link");
        }
  ...
  const accordionItems = document.querySelectorAll(
    ".rs-accordion-item.has-border-active",
  );
